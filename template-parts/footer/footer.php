<div data-kubio="kubio/section" id="footer">
		<div class="bg-gray-800 text-white pt-10">
					<div class="container mx-auto px-4 max-w-7xl">
						...
						<div class="grid grid-cols-2 md:grid-cols-6 gap-8 mb-10">
							...
							<div class="text-left">
								<h4 class="font-light mb-2 text-white">Explore</h4>
								<div class=" bottom-0 left-0 h-0.5 bg-white w-1/4"></div>
							...
							<div class="text-left">
								<h4 class="font-light mb-2 text-white">Get in touch</h4>
								<div class=" bottom-0 left-0 h-0.5 bg-white w-1/4"></div>
								<ul class="list-none space-y-1 text-sm p-0">
