<div " data-kubio="kubio/section" id="footer">
	<div class="bg-gray-900 text-white pt-10">
								<div class="container mx-auto px-4 max-w-7xl">
									...
									<div class="text-right">
										<h4 class="font-semibold mb-2 text-white">Get in touch</h4>
										<ul class="list-none space-y-1 text-sm p-0">
										<li><a href="#" class="text-white no-underline hover:underline">Newsletter</a></li>
										<li><a href="#" class="text-white no-underline hover:underline">Email</a></li>
										</ul>
									</div>

									<div class="text-right">
										<h4 class="font-semibold mb-2 text-white">Follow us</h4>
										<ul class="list-none space-y-1 text-sm p-0">
										<li><a href="#" class="text-white no-underline hover:underline">Instagram</a></li>
										<li><a href="#" class="text-white no-underline hover:underline">Linkedin</a></li>
										</ul>
									</div>
									</div>
